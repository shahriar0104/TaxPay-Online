						...
						<div class="content">
							...
							<div class="form loginBox">
								<form method="post" action="index.php" accept-charset="UTF-8">
									...
									<input id="code" class="form-control" type="text" placeholder="Verification Code" name="code">
									<input class="btn btn-default btn-login" type="button" value="Login" onclick="loginVerifyAjax()">
								</form>
							</div>
						</div>
					</div>
